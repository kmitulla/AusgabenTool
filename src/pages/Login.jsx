...
const styles = {
  ...
  card: {
    ...
    width: '100%',
    maxWidth: '420px',
    boxShadow: '0 24px 60px -20px rgba(15, 23, 42, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.9)',
    position: 'relative',
    zIndex: 2,
  },
  iconWrap: {
  ...
  button: {
    ...
    boxShadow: 'inset 0 1px 0 rgba(255, 255, 255, 0.4), 0 6px 20px -8px rgba(14, 165, 233, 0.6)',
    letterSpacing: '0.02em',
    marginTop: '0.5rem',
  },
  buttonHover: {
    transform: 'translateY(-1px)',
    boxShadow: 'inset 0 1px 0 rgba(255, 255, 255, 0.4), 0 10px 28px -10px rgba(14, 165, 233, 0.7)',
  },
  buttonDisabled: {
    opacity: 0.6,
    cursor: 'not-allowed',
