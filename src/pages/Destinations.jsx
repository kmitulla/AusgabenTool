...
const styles = {
  ...
  overlay: {
    ...
    zIndex: 2000, padding: '2rem 1rem', overflowY: 'auto',
  },
  modal: {
    background: 'linear-gradient(135deg, #1e293b, #0f172a)', borderRadius: '20px',
    border: '1px solid rgba(255,255,255,0.1)', width: '100%', maxWidth: '600px',
    padding: '1.5rem', color: '#f1f5f9', position: 'relative',
  },
  modalTitle: { fontSize: '1.3rem', fontWeight: 700, marginBottom: '1.25rem' },
  label: { fontSize: '0.8rem', fontWeight: 600, color: '#94a3b8', marginBottom: '0.3rem', display: 'block' },
  input: {
